  ...
  sui: [
    {
      ...
      type: SUI_TYPE_ARG,
      symbol: 'SUI',
      name: ASSET_METADATA[SUI_TYPE_ARG].name,
    ...
    },
    {
      chain: 'sui',
      type: WSOL_SUI_TYPE,
      symbol: BRIDGED_ASSET_METADATA[WSOL_SUI_TYPE].symbol,
  ...
  solana: [
    {
      ...
      type: SOL_TYPE,
      symbol: 'SOL',
      name: ASSET_METADATA[SOL_TYPE].name,
    ...
    },
    {
      ...
      symbol: BRIDGED_ASSET_METADATA[WSUI_SOLANA_MINT].symbol,
      name: BRIDGED_ASSET_METADATA[WSUI_SOLANA_MINT].name,
