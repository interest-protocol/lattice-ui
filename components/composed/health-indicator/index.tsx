  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center gap-2 bg-surface-raised rounded-lg border border-surface-border p-2 sm:py-2 sm:px-3 sm:cursor-pointer sm:hover:bg-surface-overlay transition-colors duration-200 focus-ring"
        onClick={() => {
