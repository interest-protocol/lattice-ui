...
const ConnectWallet: FC<ConnectWalletProps> = ({ onConnect }) => (
  <motion.button
    type="button"
    className="flex text-white cursor-pointer relative items-center rounded-xl gap-2 sm:gap-4 py-3 sm:py-4 px-3 sm:px-6 border-none font-semibold transition-colors duration-200 focus-ring"
    style={{
